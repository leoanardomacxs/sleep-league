    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-sm text-muted-foreground font-body mt-1">Evolua seu sono</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            disabled={loading}
            className="w-full h-12 rounded-xl flex items-center justify-center gap-2 text-sm font-ui uppercase text-primary-foreground disabled:opacity-50"
            style={{
              background: "linear-gradient(135deg, hsl(265 100% 70%), hsl(190 100% 65%))",
            }}
          >
        ...
        <p className="text-center text-sm text-muted-foreground font-body mt-6">
          ...
          <button type="button" onClick={() => setIsSignUp(!isSignUp)} className="text-primary font-ui">
